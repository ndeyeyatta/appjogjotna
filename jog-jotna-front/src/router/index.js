...
const routes = [
  ...
  { path: '/evaluations/creer',        name: 'evaluation-creer',    component: () => import('@/pages/EvaluationForm.vue'),       props: r => ({ enfantId: r.query.enfant ? parseInt(r.query.enfant) : null }), meta: { auth: true } },
  ...
  { path: '/seances/creer',            name: 'seance-creer',        component: () => import('@/pages/SeanceForm.vue'),           meta: { auth: true } },
